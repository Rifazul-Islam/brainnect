...
const Video = () => {
    return (
        <div className="max-w-[1300px] mx-auto py-10">
            <div className="w-3/4 mx-auto h-[600px] p-5 relative">
                <iframe className="w-full h-full rounded-3xl z-10 border-4 border-white" src="https://www.youtube.com/embed/bjQF77dxUdg?si=nu331e8Bv34ZuCYz" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
